...
from litellm import completion# Used to call an LLM (here: gpt-4.1-nano) as an automatic judge.
...
# test: TestQuestion
# A test case that contains:
# test.question → the user query
# test.keywords → ground-truth keywords that should appear in relevant docs
